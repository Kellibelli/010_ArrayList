...
public class StudentFirstNames {
	...
	public void showContents() {
		...
		//for (int i = 0; i < a2Students.size(); i++) {
			JOptionPane.showMessageDialog(null, "Contains: " + a2Students);
	...
	public void addName() {
		String entry = JOptionPane.showInputDialog("What is your name student?");
	...
	public void removeName() {
		String name = JOptionPane.showInputDialog("Which name would you like to remove?");
